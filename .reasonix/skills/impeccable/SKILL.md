...
allowed-tools:
  - Bash(npx impeccable *)
  - Bash(node .reasonix/skills/impeccable/scripts/*)
---
...
```bash
node .reasonix/skills/impeccable/scripts/pin.mjs <pin|unpin> <command>
```
